...
const pilgrim_schema = new mongoose.Schema({
    ...
    national_id: { type: String, unique: true, required: true }, // National/State ID for pilgrims
    phone_number: { type: String, unique: true, required: true }, // Each user has unique phone number
    ...
    role: { type: String, enum: ['pilgrim', 'moderator'], default: 'pilgrim' }, // Role can be upgraded to moderator
    ...
    created_by: { type: mongoose.Schema.Types.ObjectId, ref: 'User' } // Optional, for moderator-created pilgrims
});
